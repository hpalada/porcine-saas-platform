...
export function PigLogo({ size = 32, className = '' }: { size?: number; className?: string }) {
  // Cerdito rosado profesional con orejas redondas
  const pink = '#f9a8d4';
  const pinkDark = '#ec4899';
  const pinkInner = '#f5b9d3';
  return (
    <svg width={size} height={size} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} aria-label="Pig logo">
      {/* Orejas redondas */}
      <circle cx="17" cy="20" r="7" fill={pink} stroke={pinkDark} strokeWidth="1.2" />
      <circle cx="17" cy="20" r="3.4" fill={pinkInner} />
      <circle cx="47" cy="20" r="7" fill={pink} stroke={pinkDark} strokeWidth="1.2" />
      <circle cx="47" cy="20" r="3.4" fill={pinkInner} />
      {/* Cabeza */}
      <ellipse cx="32" cy="35" rx="22" ry="20" fill={pink} stroke={pinkDark} strokeWidth="1.2" />
      {/* Hocico */}
      <ellipse cx="32" cy="42" rx="11.5" ry="8.5" fill={pinkInner} stroke={pinkDark} strokeWidth="1.2" />
      {/* Fosas nasales */}
      <ellipse cx="28" cy="42" rx="1.6" ry="2.6" fill="#831843" />
      <ellipse cx="36" cy="42" rx="1.6" ry="2.6" fill="#831843" />
      {/* Ojos */}
      <circle cx="24" cy="29" r="2.6" fill="#1f2937" />
      <circle cx="40" cy="29" r="2.6" fill="#1f2937" />
      <circle cx="24.8" cy="28.2" r="0.9" fill="white" />
      <circle cx="40.8" cy="28.2" r="0.9" fill="white" />
    </svg>
  );
}
...
export function IconWheat({ size = 18, className = '' }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M2 22 16 8" />
...
export function IconTrendingDown({ size = 18, className = '' }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export function IconPill({ size = 14, className = '' }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export function IconTruck({ size = 14, className = '' }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export function IconMinus({ size = 12, className = '' }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <line x1="5" y1="12" x2="19" y2="12" />
    </svg>
...
export function IconSyringe({ size = 14, className = '' }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="m18 2 4 4" />
      <path d="m17 7 3-3" />
...
export function IconWeight({ size = 14, className = '' }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <circle cx="12" cy="5" r="3" />
      <path d="M6.5 8a2 2 0 0 0-1.905 1.46L2.1 18.5A2 2 0 0 0 4 21h16a2 2 0 0 0 1.925-2.54L19.4 9.46A2 2 0 0 0 17.48 8Z" />
    </svg>
  );
}
