...
async function run() {
    ...
    for (const lote of lotes) {
        ...
        if (lote.cantidadSalida !== nuevaSalida ||
            ...
            await db.collection('lotes').updateOne({ _id: lote._id }, { $set: { cantidadSalida: nuevaSalida, cantidadMuertas: totalMuertas, cantidadActual: nuevaActual, estado: nuevoEstado } });
            updated++;
